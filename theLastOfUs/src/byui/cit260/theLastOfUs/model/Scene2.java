...
public class Scene2 implements Serializable {
    ...
    public int hashCode() {
        ...
        hash = 97 * hash + (this.DisplaySymbol ? 1 : 0);
        return hash;
    }
    ...
    public String toString() {
        return "Scene2{" + "name=" + name + ", description=" + description + ", travelTime=" + travelTime + ", DisplaySymbol=" + DisplaySymbol + '}';
    }
