...
public class Scene3 implements Serializable {
    ...
    public int hashCode() {
        ...
        hash = 17 * hash + (this.DisplaySymbol ? 1 : 0);
        return hash;
    }
    ...
    public String toString() {
        return "Scene3{" + "name=" + name + ", description=" + description + ", travelTime=" + travelTime + ", DisplaySymbol=" + DisplaySymbol + '}';
    }
