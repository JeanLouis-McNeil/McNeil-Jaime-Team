 ...
 * @author iu
 */
public class Scene6 implements Serializable{
        private String name;
    ...
    public int hashCode() {
        ...
        hash = 31 * hash + (this.DisplaySymbol ? 1 : 0);
        return hash;
    }
    ...
    public String toString() {
        return "Scene6{" + "name=" + name + ", description=" + description + ", travelTime=" + travelTime + ", DisplaySymbol=" + DisplaySymbol + '}';
    }
